...
# settings
project_id = 'ba882-rgk'  # <------- change this to your value
...
def task(request):
  ...
  GCS_PATH = "gs://rgk-ba882-fall24-vertex-models/training-data/post-length/post-length.csv"
  ...
  GCS_BUCKET = "rgk-ba882-fall24-vertex-models"
