...
def schema_setup():
    ...
    url = "https://us-central1-ba882-rgk.cloudfunctions.net/dev-schema-setup"
...
def extract():
    ...
    url = "https://us-central1-ba882-rgk.cloudfunctions.net/dev-extract-rss"
    resp = invoke_gcf(url, payload={})
    return resp
...
def transform(payload):
    ...
    url = "https://us-central1-ba882-rgk.cloudfunctions.net/dev-parse-rss"
...
def load(payload):
    ...
    url = "https://us-central1-ba882-rgk.cloudfunctions.net/dev-load-rss"
    resp = invoke_gcf(url, payload=payload)
    return resp
