...
#                 # Convert 'Date' to datetime and handle errors (invalid dates)
#                 df['Date'] = pd.to_datetime(df['Date'], errors='coerce').dt.date  # Convert to date and ignore errors
