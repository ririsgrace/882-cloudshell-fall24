...
#         SELECT * FROM data WHERE Date NOT IN (SELECT Date FROM {db_schema}.{tbl_name});
#         """)

#     return "Schema setup and data insertion for multiple tickers successful!", 200
...
#         Close FLOAT(2),         -- Closing Price
#         Adj_Close FLOAT(2),     -- Adjusted Close Price
#         Volume FLOAT(2)         -- Trading Volume (corrected from Volumn),
#         Ticker VARCHAR
#     );
#     """
#     md.sql(table_create_sql)
